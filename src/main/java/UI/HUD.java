...
public class HUD extends GuiComponent {
    ...
    private static final BufferedImage HealthbarIn = Imaging.scale(Resources.images().get("src/main/resources/hud/Lebensleiste_innen.png"), 5.0);
    private static final BufferedImage HealthbarOut = Imaging.scale(Resources.images().get("src/main/resources/hud/Lebensleiste_Rahmen_v2.png"), 5.0);
    ...
    private static Font f = new Font("Mistlock Typeface", Font.PLAIN, 20);
