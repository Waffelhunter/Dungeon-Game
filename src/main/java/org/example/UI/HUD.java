...
public class HUD extends GuiComponent {
    ...
    private static final BufferedImage HEART = Imaging.scale(Resources.images().get("resources/hud/life.png"), 5.0);
    private static final BufferedImage HEARTEMPTY = Imaging.scale(Resources.images().get("resources/hud/herzleer.png"), 5.0);
    private static final BufferedImage ARMOR = Imaging.scale(Resources.images().get("resources/hud/Ruestung.png"), 5.0);
    private static final BufferedImage ARMOREMPTY = Imaging.scale(Resources.images().get("resources/hud/RuestungLeer.png"), 5.0);
